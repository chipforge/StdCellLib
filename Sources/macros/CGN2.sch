...
E {}
T {Synchronizing:
- latch low-active enable during high-phase (transparent)} 20 -180 0 0 0.2 0.2 {}
T {Drive:
- skewed clock driver} 450 -40 0 0 0.2 0.2 {}
T {Combine:
- low-active enable signal
- low clock phase} 280 -40 0 0 0.2 0.2 {}
N 40 -120 80 -120 {lab=EN}
...
C {ipin.sym} 50 -120 0 0 {name=p1 lab=EN}
C {lab_wire.sym} 240 -120 0 0 {name=l1 lab=enable}
C {ipin.sym} 50 -80 0 0 {name=p0 lab=XI}
C {opin.sym} 560 -100 0 0 {name=p2 lab=XO}
C {../Symbols/LATP.sym} 140 -100 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {../Symbols/NOR2.sym} 330 -100 0 0 {name=x2 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
