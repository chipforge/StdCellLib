...
- reduces fan-in} 130 -580 0 0 0.2 0.2 {}
T {S = 1 arm/branch
...
N 30 -490 70 -490 {lab=S}
N 170 -490 240 -490 { lab=s0}
N 150 -190 150 -170 { lab=#net1}
...
N 150 -270 150 -250 { lab=#net2}
N 150 -110 150 -90 { lab=#net3}
...
N 370 -190 370 -170 { lab=#net4}
N 360 -140 370 -140 { lab=GND}
N 420 -180 480 -180 { lab=A0}
N 370 -270 370 -250 { lab=#net5}
N 370 -110 370 -90 { lab=#net6}
...
N 150 -180 370 -180 {}
N 260 -180 260 -160 {}
C {ipin.sym} 40 -490 0 0 {name=p1 lab=S}
C {lab_wire.sym} 230 -490 0 0 {name=l1 lab=s0}
C {lab_wire.sym} 400 -490 0 0 {name=l0 lab=s1}
C {../Symbols/INV.sym} 110 -490 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
