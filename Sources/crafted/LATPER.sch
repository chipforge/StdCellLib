...
N 420 -110 470 -110 {lab=clk360}
N 420 10 470 10 {lab=clk180}
N 40 -70 80 -70 {lab=D}
...
C {lab_wire.sym} 460 -110 0 0 {name=l5 lab=clk360}
...
C {../Symbols/NAND2.sym} 130 -280 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
