...
C {../Symbols/NOR2.sym} 300 -50 0 0 {name=x4 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
...
C {../Symbols/TRI.sym} 460 -50 0 0 {name=x6 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
