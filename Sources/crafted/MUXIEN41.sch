...
N 40 -630 60 -630 { lab=EN}
N 480 -670 510 -670 { lab=S1}
N 480 -630 510 -630 { lab=E}
...
C {../Symbols/NOR2.sym} 120 -650 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 50 -630 0 0 {name=p8 lab=EN}
C {../Symbols/NOR2.sym} 570 -650 0 0 {name=x3 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 490 -630 0 0 {name=p9 lab=EN}
