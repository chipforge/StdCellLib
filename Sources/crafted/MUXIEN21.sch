...
- reduces fan-in
- involves low-active Enable} 130 -580 0 0 0.2 0.2 {}
T {S = 1 arm/branch
...
C {../Symbols/NOR2.sym} 110 -490 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 40 -470 0 0 {name=p5 lab=EN}
