...
C {tri.sym} 450 -50 0 0 {name=x5 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
...
C {nor2.sym} 120 -280 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 210 -30 0 0 {name=p4 lab=SN}
C {/home/kubrick/Projects/github.com/StdCellLib/Sources/crafted/nand2.sym} 300 -50 0 0 {name=x4 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
