...
T {QN Stage:
- (inverting) tri-state driver
- clock high-active (transparent)} 420 -200 0 0 0.2 0.2 {}
T {Q Stage:
- inverting AND
...
C {/home/kubrick/Projects/github.com/StdCellLib/Sources/Symbols/AOI21.sym} 130 -300 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {/home/kubrick/Projects/github.com/StdCellLib/Sources/Symbols/INV.sym} 350 -280 0 0 {name=x2 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
...
C {/home/kubrick/Projects/github.com/StdCellLib/Sources/Symbols/TRI.sym} 440 -50 0 0 {name=x5 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
