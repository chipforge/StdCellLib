...
N 230 -430 230 -410 { lab=#net3}
N 240 -460 240 -300 { lab=VDD}
N 230 -380 240 -380 { lab=VDD}
N 230 -110 230 -90 { lab=#net4}
N 230 -190 230 -170 { lab=#net5}
...
N 450 -430 450 -410 { lab=#net7}
N 460 -460 460 -300 { lab=VDD}
N 450 -380 460 -380 { lab=VDD}
N 450 -110 450 -90 { lab=#net8}
N 450 -190 450 -170 { lab=#net9}
...
N 680 -430 680 -410 { lab=#net11}
N 690 -460 690 -300 { lab=VDD}
N 680 -380 690 -380 { lab=VDD}
N 680 -110 680 -90 { lab=#net12}
N 680 -190 680 -170 { lab=#net13}
...
N 900 -430 900 -410 { lab=#net15}
N 910 -460 910 -300 { lab=VDD}
N 900 -380 910 -380 { lab=VDD}
N 900 -110 900 -90 { lab=#net16}
N 900 -190 900 -170 { lab=#net17}
...
N 40 -670 60 -670 { lab=S0}
N 40 -630 60 -630 { lab=E}
N 480 -670 510 -670 {}
N 480 -630 510 -630 {}
C {ipin.sym} 50 -670 0 0 {name=p1 lab=S0}
...
C {ipin.sym} 490 -670 0 0 {name=p5 lab=S1}
...
C {../Symbols/NAND2.sym} 120 -650 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 50 -630 0 0 {name=p8 lab=E}
C {../Symbols/NAND2.sym} 570 -650 0 0 {name=x3 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
C {ipin.sym} 490 -630 0 0 {name=p9 lab=E}
