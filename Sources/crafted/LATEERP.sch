...
C {tri.sym} 480 -50 0 0 {name=x5 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
...
C {/home/kubrick/Projects/github.com/StdCellLib/Sources/crafted/oai21.sym} 140 -260 0 0 {name=x1 VDD=VDD GND=GND Wmin=1.5u Lmin=1u g=2 m=1}
