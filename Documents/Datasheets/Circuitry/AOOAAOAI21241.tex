...
%%
%%  File:           StdCellLib/Documents/Datasheets/Circuitry/AOOAAOAI21241.tex
%%
%%  Purpose:        Circuit File for AOOAAOAI21241
%%
...
\begin{circuitdiagram}[draft]{39}{22}
    ...
    % ----  4th column  ----
    \wire{23}{9}{23}{14}
    \gate[\inputs{2}]{or}{26}{16}{R}{}{}

    % ----  5th column  ----
    \pin{29}{20}{L}{E}
    \gate[\inputs{2}]{nand}{33}{18}{R}{}{}
