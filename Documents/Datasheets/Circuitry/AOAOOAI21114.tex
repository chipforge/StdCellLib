...
%%
%%  File:           StdCellLib/Documents/Datasheets/Circuitry/AOAOOAI21114.tex
%%
%%  Purpose:        Circuit File for AOAOOAI21114
%%
...
\begin{circuitdiagram}[draft]{39}{20}
    ...
    \pin{22}{17}{L}{E2}
    \pin{22}{19}{L}{E3}
    \gate[\inputs{4}]{or}{26}{16}{R}{}{}

    % ----  5th column  ----
    \wire{30}{9}{30}{12}
    \gate[\inputs{2}]{nand}{33}{14}{R}{}{}
