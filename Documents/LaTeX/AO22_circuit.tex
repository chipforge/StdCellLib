...
%%
%%  File:           StdCellLib/Documents/LaTeX/AO22_circuit.tex
%%
...
\begin{center}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \pin{1}{5}{L}{C}    % pin C
            \pin{1}{9}{L}{C1}   % pin C2
            \wire{9}{5}{9}{7}   % wire between AND and NOR
            \wire{2}{1}{9}{1}   % wire between pin and NOR
            \wire{2}{3}{9}{3}   % wire between pin and NOR
            \pin{23}{3}{R}{Z}   % pin Z
            \end{circuitdiagram}
        \end{center}
    \end{figure}
