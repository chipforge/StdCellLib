...
OOOAI3321:      DESCR = "3-3-2-1-input OR-OR-OR-AND gate"
OOOAI3321:      OOOAI332
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
AAAOAI3331:     DESCR = "3-3-3-1-input AND-AND-AND-OR-AND gate"
AAAOAI3331:     AAAOI333
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
OOOAAOI22221:   DESCR = "2-2-2-2-1-input OR-OR-OR-AND-AND-OR gate"
