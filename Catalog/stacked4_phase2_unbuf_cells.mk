...
AAOI422:        DESCR = "4-2-2-input AND-AND-OR-Invert gate"
AAOI422:        AAOI421
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AAOI431:        DESCR = "4-3-1-input AND-AND-OR-Invert gate"
AAOI431:        AAOI43
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)
...
AAAOI422:       DESCR = "4-2-2-input AND-AND-AND-OR-Invert gate"
AAAOI422:       AAOI421
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
AAAAOI3332:     DESCR = "3-3-3-2-input AND-AND-AND-AND-OR-Invert gate"
AAAAOI3332:     AAAOI3331
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

OOOOAI3332:     DESCR = "3-3-3-2-input OR-OR-OR-OR-AND-Invert gate"
OOOOAI3332:     OOOAI3331
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
