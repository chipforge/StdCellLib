...
AOOA234:        DESCR = "3-2-4-input AND-OR-OR-AND gate"
AOOA234:        AOOA233
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OAAO234:        DESCR = "3-2-4-input OR-AND-AND-OR gate"
OAAO234:        OAAO233
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
AOOA324:        DESCR = "3-2-4-input AND-OR-OR-AND gate"
AOOA324:        AOOA323
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AOOA333:        DESCR = "3-3-3-input AND-OR-OR-AND gate"
AOOA333:        AOOA332
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
OAAO2331:       DESCR = "2-3-3-1-input OR-AND-AND-OR gate"
OAAO2331:       OAAO233
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)
...
OAAO2321:       DESCR = "2-3-2-1-input OR-AND-AND-AND-OR gate"
OAAO2321:       OAAO232
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)

AOOA2331:       DESCR = "2-3-3-1-input AND-OR-OR-AND gate"
AOOA2331:       AOOA233
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
AAOOA324:       DESCR = "3-2-4-input AND-AND-OR-OR-AND gate"
AAOOA324:       AAOOA323
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AAOOA333:       DESCR = "3-3-3-input AND-AND-OR-OR-AND gate"
AAOOA333:       AAOOA332
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AAOOA2223:      DESCR = "2-2-2-3-input AND-AND-OR-OR-AND gate"
AAOOA2223:      AAOOA2222
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OOAAO2223:      DESCR = "2-2-2-3-input OR-OR-AND-AND-OR gate"
OOAAO2223:      OOAAO2222
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
AAOOA3213:      DESCR = "3-2-1-3-input AND-AND-OR-OR-AND gate"
AAOOA3213:      AAOOA3212
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

AAOOA3222:      DESCR = "3-2-2-2-input AND-AND-OR-OR-AND gate"
AAOOA3222:      AAOA3221
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AOOOA2133:      DESCR = "2-1-3-3-input AND-OR-OR-OR-AND gate"
AOOOA2133:      AOOOA2132
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OAAAO2133:      DESCR = "2-1-3-3-input OR-AND-AND-AND-OR gate"
OAAAO2133:      OAAAO2132
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

AOOOA2142:      DESCR = "2-1-4-2-input AND-OR-OR-OR-AND gate"
AOOOA2142:      AOOA2141
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OAAAO2142:      DESCR = "2-1-4-2-input OR-AND-AND-AND-OR gate"
OAAAO2142:      OAAO2141
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

AOOOA2222:      DESCR = "2-2-2-2-input AND-OR-OR-OR-AND gate"
AOOOA2222:      AOOA2221
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
OAAAO2223:      DESCR = "2-2-2-3-input OR-AND-AND-AND-OR gate"
OAAAO2223:      OAAAO2222
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
AOOOA2322:      DESCR = "2-3-2-2-input AND-OR-OR-OR-AND gate"
AOOOA2322:      AOOA2321
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OAAAO2322:      DESCR = "2-3-2-2-input OR-AND-AND-AND-OR gate"
OAAAO2322:      OAAO2321
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
OOOAO22211:     DESCR = "2-2-2-1-1-input OR-OR-OR-AND-OR gate"
OOOAO22211:     OOOA2221
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)

AAAOA22212:     DESCR = "2-2-2-1-2-input AND-AND-AND-OR-AND gate"
AAAOA22212:     AAAOA22211
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

OOOAO22212:     DESCR = "2-2-2-1-2-input OR-OR-OR-AND-OR gate"
OOOAO22212:     OOOAO22211
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
AAAOA33311:     DESCR = "3-3-3-1-1-input AND-AND-AND-OR-AND gate"
AAAOA33311:     AAAO3331
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)

OOOAO33311:     DESCR = "3-3-3-1-1-input OR-OR-OR-AND-OR gate"
OOOAO33311:     OOOA3331
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)
...
AAOOA22221:     DESCR = "2-2-2-2-1-input AND-AND-OR-OR-AND gate"
AAOOA22221:     AAOOA2222
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)

OOAAO22221:     DESCR = "2-2-2-2-1-input OR-OR-AND-AND-OR gate"
OOAAO22221:     OOAAO2222
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)
...
AAAOOA3332:     DESCR = "3-3-3-2-input AND-AND-AND-OR-OR-AND gate"
AAAOOA3332:     AAAOA3331
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OOOAAO3332:     DESCR = "3-3-3-2-input OR-OR-OR-AND-AND-OR gate"
OOOAAO3332:     OOOAO3331
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

AAAAOA22221:    DESCR = "2-2-2-2-1-input AND-AND-AND-AND-OR-AND gate"
AAAAOA22221:    AAAAO2222
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)

OOOOAO22221:    DESCR = "2-2-2-2-1-input AND-AND-AND-AND-OR-AND gate"
OOOOAO22221:    OOOOA2222
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)

AAAOOA22212:    DESCR = "2-2-2-1-2-input AND-AND-AND-OR-OR-AND gate"
AAAOOA22212:    AAAOA22211
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

OOOAAO22212:    DESCR = "2-2-2-1-2-input OR-OR-OR-AND-AND-OR gate"
OOOAAO22212:    OOOAO22211
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
...
OOOAAO22241:    DESCR = "2-2-2-4-1-input OR-OR-OR-AND-AND-OR gate"
OOOAAO22241:    OOOAAO2224
	$(POPCORN) -m pd -c $@ $< > $@
	$(STACKED4)
...
OOOAAAO22232:   DESCR = "2-2-2-3-2-input OR-OR-OR-AND-AND-AND-OR gate"
OOOAAAO22232:   OOOAAO22231
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)
