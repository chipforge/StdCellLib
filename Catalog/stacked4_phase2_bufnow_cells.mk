...
#
#   File:           StdCellLib/Catalog/stacked4_phase2_bufnow_cells.mk
#
...
OOOOA3222:      DESCR = "3-2-2-2-input OR-OR-OR-OR-AND gate"
OOOOA3222:      OOOA3221
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)

AAAAO3322:      DESCR = "3-3-2-2-input AND-AND-AND-AND-OR gate"
AAAAO3322:      AAAO3321
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

OOOOA3322:      DESCR = "3-3-2-2-input OR-OR-OR-OR-AND gate"
OOOOA3322:      OOOA3321
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
