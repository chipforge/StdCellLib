...
CELLS +=        AOAOAO211111 OAOAOA211111 \
                ...
                AOAOAAO211113 OAOAOOA211113 \
                AOAOOAO211121 OAOAAOA211121 \
                AOAOOAO211131 OAOAAOA211131 \
                ...
                AOOAOOAO212121 OAAOAAOA212121 \
                AOOAOAAO212112 OAAOAOOA212112 \
                AOAAOAAO211212 OAOOAOOA211212 \
                AOAAOOAO211221 OAOOAAOA211221 \
                AOAOOAAO211122 OAOAAOOA211122 \
...
AOAOAAO211113:  DESCR = "2-1-1-1-1-3-input AND-OR-AND-OR-AND-AND-OR gate"
AOAOAAO211113:  AOAOAAO211112
	$(POPCORN) -m nand -c $@ $< > $@
	$(STACKED4)

OAOAOOA211113:  DESCR = "2-1-1-1-1-3-input OR-AND-OR-AND-OR-OR-AND gate"
OAOAOOA211113:  OAOAOOA211112
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
OAOAAOA211131:  DESCR = "2-1-1-1-3-1-input OR-AND-OR-AND-AND-OR-AND gate"
OAOAAOA211131:  OAOAAO21113
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
OAAOAAOA212121: DESCR = "2-1-2-1-2-1-input OR-AND-AND-OR-AND-AND-OR-AND gate"
OAAOAAOA212121: OAAOAAO21212
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
OAAOAOOA212112: DESCR = "2-1-2-1-1-2-input OR-AND-AND-OR-AND-OR-OR-AND gate"
OAAOAOOA212112: OAAOAOA212111
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
OAOOAOOA211212: DESCR = "2-1-1-2-1-2-input OR-AND-OR-OR-AND-OR-OR-AND gate"
OAOOAOOA211212: OAOOAOA211211
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
...
OAOOAAOA211221: DESCR = "2-1-1-2-2-1-input OR-AND-OR-OR-AND-AND-OR-AND gate"
OAOOAAOA211221: OAOOAAO21122
	$(POPCORN) -m pu -c $@ $< > $@
	$(STACKED4)
...
OAOAAOOA211122: DESCR = "2-1-1-1-2-2-input OR-AND-OR-AND-AND-OR-OR-AND gate"
OAOAAOOA211122: OAOAAOA211121
	$(POPCORN) -m nor -c $@ $< > $@
	$(STACKED4)
